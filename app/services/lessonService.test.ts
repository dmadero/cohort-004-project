...
describe("lessonService", () => {
  ...
  describe("createLesson", () => {
    it("creates a lesson with explicit position", () => {
      const lesson = createLesson({ moduleId: moduleId, title: "Lesson 1", content: "Some content", videoUrl: null, position: 1, durationMinutes: 30 });
    ...
    it("auto-calculates position when null", () => {
      createLesson({ moduleId: moduleId, title: "Lesson 1", content: null, videoUrl: null, position: null, durationMinutes: null });
      const l2 = createLesson({ moduleId: moduleId, title: "Lesson 2", content: null, videoUrl: null, position: null, durationMinutes: null });

      expect(l2.position).toBe(2);
    });

    it("starts auto position at 1 for empty module", () => {
      const lesson = createLesson({ moduleId: moduleId, title: "First", content: null, videoUrl: null, position: null, durationMinutes: null });

      expect(lesson.position).toBe(1);
    });

    it("creates a lesson with video URL", () => {
      const lesson = createLesson({ moduleId: moduleId, title: "Video Lesson", content: null, videoUrl: "https://youtube.com/watch?v=abc123", position: 1, durationMinutes: null });
  ...
  describe("getLessonById", () => {
    it("returns a lesson by id", () => {
      const created = createLesson({ moduleId: moduleId, title: "Find Me", content: null, videoUrl: null, position: 1, durationMinutes: null });
  ...
  describe("getLessonsByModule", () => {
    it("returns lessons ordered by position", () => {
      createLesson({ moduleId: moduleId, title: "Third", content: null, videoUrl: null, position: 3, durationMinutes: null });
      createLesson({ moduleId: moduleId, title: "First", content: null, videoUrl: null, position: 1, durationMinutes: null });
      createLesson({ moduleId: moduleId, title: "Second", content: null, videoUrl: null, position: 2, durationMinutes: null });
  ...
  describe("getLessonCount", () => {
    it("returns the number of lessons in a module", () => {
      createLesson({ moduleId: moduleId, title: "L1", content: null, videoUrl: null, position: 1, durationMinutes: null });
      createLesson({ moduleId: moduleId, title: "L2", content: null, videoUrl: null, position: 2, durationMinutes: null });
  ...
  describe("updateLesson", () => {
    it("updates title when provided", () => {
      const lesson = createLesson({ moduleId: moduleId, title: "Old", content: "old content", videoUrl: null, position: 1, durationMinutes: 10 });
    ...
    it("updates content when provided", () => {
      const lesson = createLesson({ moduleId: moduleId, title: "Title", content: "old content", videoUrl: null, position: 1, durationMinutes: null });
    ...
    it("updates multiple fields at once", () => {
      const lesson = createLesson({ moduleId: moduleId, title: "Old", content: null, videoUrl: null, position: 1, durationMinutes: null });
    ...
    it("returns lesson unchanged when all fields are null", () => {
      const lesson = createLesson({ moduleId: moduleId, title: "Same", content: "same content", videoUrl: null, position: 1, durationMinutes: 10 });
  ...
  describe("updateLessonTitle", () => {
    it("updates just the title", () => {
      const lesson = createLesson({ moduleId: moduleId, title: "Old Title", content: null, videoUrl: null, position: 1, durationMinutes: null });
  ...
  describe("deleteLesson", () => {
    it("deletes a lesson", () => {
      const lesson = createLesson({ moduleId: moduleId, title: "Delete Me", content: null, videoUrl: null, position: 1, durationMinutes: null });
  ...
  describe("moveLessonToPosition", () => {
    it("moves a lesson down (position 1 → 3)", () => {
      const l1 = createLesson({ moduleId: moduleId, title: "L1", content: null, videoUrl: null, position: 1, durationMinutes: null });
      const l2 = createLesson({ moduleId: moduleId, title: "L2", content: null, videoUrl: null, position: 2, durationMinutes: null });
      const l3 = createLesson({ moduleId: moduleId, title: "L3", content: null, videoUrl: null, position: 3, durationMinutes: null });
  ...
  describe("reorderLessons", () => {
    ...
    it("assigns positions starting at 1 and normalizes gaps", () => {
      const l1 = createLesson({ moduleId: moduleId, title: "L1", content: null, videoUrl: null, position: 10, durationMinutes: null });
      const l2 = createLesson({ moduleId: moduleId, title: "L2", content: null, videoUrl: null, position: 20, durationMinutes: null });
